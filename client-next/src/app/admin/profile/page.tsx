  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-black tracking-tight text-slate-900">Hồ sơ cá nhân</h1>
        <p className="text-slate-500 font-medium">Quản lý thông tin tài khoản và cài đặt bảo mật của bạn.</p>
      </div>
        ...
        <div className="md:col-span-1 space-y-6">
          <Card className="border-none shadow-xl shadow-slate-200/50 overflow-hidden bg-white">
            ...
            <div className="px-6 py-4 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Tài khoản từ</span>
          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 bg-primary text-white overflow-hidden relative group">
             ...
             <CardHeader className="pb-2">
                ...
                <CardDescription className="text-white/70 text-xs font-medium">Tài khoản của bạn đang được bảo vệ.</CardDescription>
             </CardHeader>
             <CardContent>
        ...
        <div className="md:col-span-2">
          <Card className="border-none shadow-2xl shadow-slate-200/40 bg-white rounded-2xl overflow-hidden">
            <CardHeader className="border-b border-slate-50 pb-6">
              <CardTitle className="text-xl font-bold text-slate-900">Chỉnh sửa thông tin</CardTitle>
              <CardDescription className="font-medium">Cập nhật thông tin chi tiết và cài đặt mật khẩu mới.</CardDescription>
            </CardHeader>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input {...field} placeholder="Nguyễn Văn A" className="pl-10 h-11 border-slate-200 focus:border-primary focus:ring-primary/5 rounded-xl font-medium" />
                            </div>
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-bold uppercase tracking-wider text-slate-500">Địa chỉ Email</FormLabel>
                          <FormControl>
                            <div className="relative">
                              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                              <Input {...field} disabled className="pl-10 h-11 border-slate-200 bg-slate-50 text-slate-500 rounded-xl font-medium cursor-not-allowed" />
                            </div>
                          </FormControl>
                          <FormMessage className="text-[10px] font-bold" />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-bold uppercase tracking-wider text-slate-500">Số điện thoại</FormLabel>
                          <FormControl>
                            <div className="relative">
                              <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                              <Input {...field} value={field.value || ""} placeholder="09xxxxxxx" className="pl-10 h-11 border-slate-200 focus:border-primary focus:ring-primary/5 rounded-xl font-medium" />
                            </div>
                          </FormControl>
                          <FormMessage className="text-[10px] font-bold" />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-bold uppercase tracking-wider text-slate-500">Mật khẩu mới (Nếu cần đổi)</FormLabel>
                          <FormControl>
                            <Input 
                              {...field} 
                              type="password" 
