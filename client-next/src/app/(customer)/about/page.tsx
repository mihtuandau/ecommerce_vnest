      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 text-center space-y-8">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto text-lg font-normal leading-relaxed">
            Chúng tôi không chỉ bán sản phẩm, chúng tôi mang đến trải nghiệm tinh tế, hiện đại và tin cậy tuyệt đối cho mọi khách hàng.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-2 gap-12 pt-4">
              <div className="space-y-2 border-l-4 border-primary pl-6">
                <p className="text-4xl font-bold text-primary tracking-tighter">50,000+</p>
                <p className="text-xs font-semibold text-slate-500">Khách hàng tin dùng</p>
              </div>
              <div className="space-y-2 border-l-4 border-primary pl-6">
                <p className="text-4xl font-bold text-primary tracking-tighter">1,000+</p>
                <p className="text-xs font-semibold text-slate-500">Sản phẩm tuyển chọn</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-50/50 py-32 border-y border-slate-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { icon: <Target className="w-8 h-8" />, title: "Tận tâm", desc: "Luôn đặt khách hàng làm trọng tâm trong mọi quyết định và hành động." },
              { icon: <Heart className="w-8 h-8" />, title: "Trung thực", desc: "Minh bạch trong mọi giao dịch và cam kết về nguồn gốc sản phẩm." },
              { icon: <Award className="w-8 h-8" />, title: "Chất lượng", desc: "Tuyển chọn những sản phẩm tốt nhất với tiêu chuẩn khắt khe." }
            ].map((item, i) => (
              <div key={i} className="p-12 bg-white rounded-[2.5rem] border border-slate-100 space-y-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
