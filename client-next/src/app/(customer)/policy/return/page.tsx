    ...
    <div className="max-w-[1000px] mx-auto py-12 md:py-20 px-4 sm:px-6">
      ...
      <div className="space-y-10 text-brand-espresso/85 leading-relaxed text-base font-normal">
        <section>
          ...
          <p className="mb-3">
            Chúng tôi chấp nhận yêu cầu trả hàng và hoàn tiền trong các trường hợp sau:
          </p>
        ...
        <section>
          ...
          <p>
            Khách hàng cần gửi yêu cầu đổi trả trong vòng <strong>30 ngày</strong> kể từ
            ngày nhận hàng thành công. Sau thời gian này, các yêu cầu đổi trả sẽ không
            được chấp nhận, khách hàng sẽ được chuyển sang chế độ bảo hành sản phẩm (nếu
            có).
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-none space-y-2">
            ...
            <li>
              • Sản phẩm chưa qua sử dụng, không có dấu hiệu trầy xước hoặc can thiệp kỹ
              thuật.
            </li>
        ...
        <section>
          ...
          <p className="mb-3">
            Chúng tôi sẽ tiến hành hoàn tiền sau khi nhận được sản phẩm trả về và kiểm
            tra tình trạng hàng hóa thành công. Thời gian hoàn tiền cụ thể:
          </p>
          <ul className="list-none space-y-2">
            <li>• Hoàn qua tài khoản ngân hàng: 3 - 5 ngày làm việc.</li>
            <li>
              • Hoàn qua thẻ tín dụng/ghi nợ: 7 - 15 ngày làm việc (tùy ngân hàng).
            </li>
            <li>
              • Phí vận chuyển hoàn trả: Sẽ do Shop chi trả nếu lỗi thuộc về nhà bán
              hàng.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Quý khách vui lòng liên hệ hotline 1900 8888 hoặc gửi email về
            support@luxe.vn để được hướng dẫn. Mọi khiếu nại sẽ được tiếp nhận và xử lý
