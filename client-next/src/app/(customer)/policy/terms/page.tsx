  ...
  return (
    <div className="max-w-[1000px] mx-auto py-12 md:py-20 px-4 sm:px-6">
      <header className="mb-12 border-b border-slate-100 pb-8">
        ...
        <p className="text-slate-500 text-sm">Quy định và thỏa thuận sử dụng dịch vụ tại Minh Tuấn Shop</p>
      </header>
      ...
      <div className="space-y-10 text-slate-700 leading-relaxed text-base font-normal">
        <section>
          ...
          <p>
            Bằng việc truy cập và sử dụng website Minh Tuấn Shop, quý khách đồng ý tuân thủ các điều khoản và điều kiện được quy định tại đây. Nếu không đồng ý với bất kỳ phần nào, vui lòng ngừng sử dụng dịch vụ của chúng tôi.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Toàn bộ nội dung trên website bao gồm văn bản, hình ảnh, logo, thiết kế đều thuộc sở hữu của Minh Tuấn Shop hoặc các bên cấp phép liên quan. Mọi hành vi sao chép, sử dụng khi chưa được sự đồng ý bằng văn bản đều bị nghiêm cấm.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Minh Tuấn Shop không chịu trách nhiệm đối với bất kỳ thiệt hại trực tiếp hoặc gián tiếp nào phát sinh từ việc sử dụng website hoặc do sản phẩm bị sử dụng sai mục đích, sai hướng dẫn của nhà sản xuất.
          </p>
        </section>
