...
import { User, Lock, Mail, Phone, Facebook, Eye, EyeOff, Check } from "lucide-react";
  ...
  return (
    <>
      ...
      <form onSubmit={handleRegister} className="space-y-3.5 sm:space-y-4">
        ...
        <Button
          type="submit"
          className="w-full h-12 rounded-[1.25rem] text-base font-bold bg-white text-slate-900 hover:bg-slate-100 shadow-[0_8px_20px_-6px_rgba(255,255,255,0.3)] hover:-translate-y-0.5 transition-all duration-300 mt-2 flex items-center justify-center gap-2"
