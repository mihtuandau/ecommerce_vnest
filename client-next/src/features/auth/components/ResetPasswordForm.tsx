      ...
      {!successState ? (
        <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="reset-otp" className="text-[11px] font-bold text-slate-200 ml-1.5 uppercase tracking-widest drop-shadow-sm">
              Mã OTP (6 số)
            </label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="reset-password" className="text-[11px] font-bold text-slate-200 ml-1.5 uppercase tracking-widest drop-shadow-sm">
              Mật khẩu mới
            </label>
            <div className="relative group">
          ...
          <div className="space-y-1.5">
            <label htmlFor="reset-confirm-password" className="text-[11px] font-bold text-slate-200 ml-1.5 uppercase tracking-widest drop-shadow-sm">
              Xác nhận mật khẩu
            </label>
            <div className="relative group">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-300 group-focus-within:text-white transition-colors" />
