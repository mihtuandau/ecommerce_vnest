...
export const PERMISSION_GROUPS: Record<string, { label: string; icon: React.ElementType; color: string; bg: string }> = {
  ...
  product:   { label: "Sản phẩm",   icon: Package,       color: "text-violet-600", bg: "bg-violet-50" },
  category:  { label: "Danh mục",   icon: Tag,           color: "text-amber-600",  bg: "bg-amber-50" },
  order:     { label: "Đơn hàng",   icon: ShoppingCart,  color: "text-emerald-600",bg: "bg-emerald-50" },
  inventory: { label: "Kho hàng",   icon: Warehouse,     color: "text-orange-600", bg: "bg-orange-50" },
  report:    { label: "Báo cáo",    icon: BarChart3,     color: "text-cyan-600",   bg: "bg-cyan-50" },
  chat:      { label: "Chat",       icon: MessageCircle, color: "text-pink-600",   bg: "bg-pink-50" },
