  ...
  return (
    <Card className="border-none shadow-sm rounded-2xl bg-slate-50/50 font-sans">
      <CardHeader className="pb-2">
        ...
        <CardTitle className="text-lg font-bold text-slate-900">Thông tin vai trò</CardTitle>
        <CardDescription className="text-xs font-medium">{roleConf.desc}</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-50 border border-amber-100 text-amber-700">
          ...
          <p className="text-[11px] leading-relaxed font-medium">
            Bất kỳ thay đổi nào đối với vai trò này sẽ yêu cầu người dùng thuộc nhóm này tải lại trang để cập nhật quyền mới.
          </p>
        </div>
      </CardContent>
    </Card>
