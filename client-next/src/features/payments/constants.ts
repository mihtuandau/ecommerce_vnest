export const PAYMENT_STATUS_CONFIG = {
  ...
  PENDING: { label: "Chờ xử lý", color: "bg-amber-50 text-amber-600 border-amber-200 animate-pulse" },
  FAILED: { label: "Thất bại", color: "bg-rose-50 text-rose-600 border-rose-200" },
  REFUNDED: { label: "Đã hoàn tiền", color: "bg-blue-50 text-blue-600 border-blue-200" },
...
export const PAYMENT_METHOD_CONFIG = {
  ...
  BANK: { label: "Chuyển khoản", color: "text-indigo-650", iconColor: "text-indigo-450" },
} as const;
