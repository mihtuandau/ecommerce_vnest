  ...
  const stats = [
    {
      ...
      trend: ((summary?.revenue?.growth ?? 0) >= 0 ? "up" : "down") as "up" | "down",
    ...
    },
    {
      ...
      trend: ((summary?.orders?.growth ?? 0) >= 0 ? "up" : "down") as "up" | "down",
    ...
    },
    {
      ...
      trend: ((summary?.users?.growth ?? 0) >= 0 ? "up" : "down") as "up" | "down",
