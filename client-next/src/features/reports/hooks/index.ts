...
export function useReportSummary(params?: Record<string, string | number | undefined>) {
  return useQuery({
...
export function useTopProducts(params?: Record<string, string | number | undefined>) {
  return useQuery({
