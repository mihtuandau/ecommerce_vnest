            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-brand-ivory pb-6">
              <div className="flex items-center gap-6">
                ...
                <div className="text-[13px] text-brand-taupe font-medium">
                  Hiển thị{" "}
                  <span className="text-primary font-bold">{totalProducts}</span> sản
                  phẩm
                </div>
              </div>
            ...
            {(currentCategory ||
              ...
              <div className="flex flex-wrap items-center gap-2 pt-2 animate-in fade-in slide-in-from-top-1 duration-500">
                ...
                {currentCategory && (
                  ...
                  >
                    Danh mục:{" "}
                    {findCategoryRecursive(categories, currentCategory)?.name ||
                      "Đang tải..."}
                    <X
                      size={12}
                      className="text-brand-taupe/40 group-hover:text-rose-500"
                    />
                  </button>
                )}
                ...
                {currentBrand && (
                  ...
                  >
                    Hiệu:{" "}
                    {brandsList.find((b: any) => String(b.id) === currentBrand)?.name ||
                      "Đang tải..."}
                    <X
                      size={12}
                      className="text-brand-taupe/40 group-hover:text-rose-500"
