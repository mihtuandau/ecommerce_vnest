...
export const HomeProductCard = React.memo(function HomeProductCard({
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col p-4 md:p-5">
          ...
          <div className="mt-auto pt-2 border-t border-[#F3EFE8] flex items-baseline gap-2.5">
            <span className="text-[18px] font-bold text-[#3D2B1A] leading-none" style={{ fontFamily: "'Playfair Display', serif" }}>
  ...
  return (
    ...
    >
      <div className="relative h-24 w-24 rounded-xl overflow-hidden bg-[#F3EFE8] shrink-0 flex items-center justify-center">
        <Image
          src={imageUrl}
          alt={product.name}
          fill
      ...
      <div className="flex-1 flex flex-col justify-between py-1">
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center gap-1.5">
            <span className="text-[16px] font-bold text-[#3D2B1A]" style={{ fontFamily: "'Playfair Display', serif" }}>
              {formatCurrency(price)}
            </span>
            {originalPrice && originalPrice > price && (
