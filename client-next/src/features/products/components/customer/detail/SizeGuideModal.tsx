...
export function SizeGuideModal({ isOpen, onClose }: SizeGuideModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-2xl bg-white border border-brand-sand rounded-2xl p-6 sm:p-8 overflow-hidden shadow-2xl">
        <DialogHeader className="space-y-2">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-brand-cream flex items-center justify-center text-brand-bronze border border-brand-ivory">
              <Compass size={20} />
            </div>
            <div>
        ...
        <div className="mt-6">
          <Tabs defaultValue="tops" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-brand-cream p-1 rounded-full border border-brand-ivory mb-6">
              <TabsTrigger
                value="tops"
            ...
            <TabsContent value="tops" className="space-y-4 outline-none">
              <div className="overflow-x-auto rounded-xl border border-brand-ivory">
                <table className="w-full border-collapse text-left text-[12px]">
                  <thead>
                    <tr className="bg-brand-cream text-primary font-bold uppercase tracking-wider border-b border-brand-ivory">
        ...
        <div className="mt-6 bg-brand-cream border border-brand-ivory rounded-xl p-4 flex gap-3">
