        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-800">
              {selectedRoom?.customer?.name || "Khách hàng"}
            </h3>
      ...
      <div className="flex gap-2">
        {!selectedRoomId?.startsWith("room_staff_") && (
          <>
            <button
              title="Gọi điện"
              className="w-9 h-9 flex items-center justify-center border border-slate-200 rounded-lg text-slate-400 hover:bg-slate-550/10 hover:text-indigo-600 transition-all cursor-pointer"
            >
              <Phone size={15} />
            </button>
            <button
              title="Đánh dấu hoàn thành"
              className="w-9 h-9 flex items-center justify-center border border-slate-200 rounded-lg text-slate-400 hover:bg-slate-555/10 hover:text-emerald-600 transition-all cursor-pointer"
            >
              <Check size={15} />
            </button>
          </>
