    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-12 bg-white">
        ...
        <p className="text-slate-400 max-w-xs text-xs leading-relaxed font-medium">
          Vui lòng chọn một cuộc hội thoại từ danh sách bên trái để bắt đầu hỗ trợ khách
          hàng.
        </p>
      </div>
    );
    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-white">
      ...
      <div className="p-5 bg-white border-t border-slate-100 relative">
        ...
        <div className="flex items-end gap-3">
          <div
            className={`flex-1 bg-slate-50/50 border rounded-2xl overflow-hidden focus-within:ring-2 focus-within:bg-white transition-all flex flex-col ${
