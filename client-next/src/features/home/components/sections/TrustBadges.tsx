      ...
      {BADGES.map((badge, index) => (
        ...
        >
          ...
          <div className="min-w-0">
            <h3 className="font-bold text-slate-800 text-[11px] md:text-sm leading-tight line-clamp-1">
              {badge.title}
            </h3>
            <p className="text-[9px] md:text-xs text-slate-500 mt-0.5 leading-snug line-clamp-2">{badge.desc}</p>
          </div>
        </div>
      ))}
    </div>
