...
export function VoucherBanner() {
  return (
    <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      <div className="bg-gradient-to-r from-primary to-primary/80 rounded-4xl p-8 md:p-12 relative overflow-hidden group shadow-2xl shadow-primary/20">
        {/* Background Patterns */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-center md:text-left">
            <div className="h-20 w-20 rounded-3xl bg-white flex items-center justify-center text-primary shadow-2xl shadow-black/10 animate-float">
              <Ticket size={40} strokeWidth={1.5} />
            </div>
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20">
                <Gift className="h-3 w-3 text-white" />
                <span className="text-xs font-semibold text-white">Quà tặng độc quyền</span>
              </div>
