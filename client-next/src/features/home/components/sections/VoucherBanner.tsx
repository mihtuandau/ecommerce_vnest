          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-center md:text-left">
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/15">
                ...
                <span className="text-[11px] font-medium text-[#F0D5BB] tracking-wide">Quà tặng độc quyền</span>
              </div>
              <h2 className="text-2xl md:text-4xl text-[#FAF8F4] tracking-tight leading-tight" style={{ fontFamily: "'Playfair Display', serif", fontWeight: 600 }}>
                Kho ưu đãi <br className="hidden md:block" /><em className="text-[#C4783A]" style={{ fontStyle: 'italic' }}>đang chờ bạn</em>
              </h2>
