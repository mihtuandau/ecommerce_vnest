...
import { 
  ShoppingCart, Trash2, Minus, Plus, X, 
  User, Ticket, Wallet, QrCode 
} from "lucide-react";
          ...
          items.map((item: any, index: number) => (
            <div key={index} className="bg-white border border-slate-100 rounded-xl p-3 flex items-center gap-3 relative shadow-sm">
              ...
              <div className="flex items-center bg-slate-50 rounded-lg border border-slate-100 p-0.5">
                <button type="button" onClick={() => onUpdateQuantity(index, -1)} className="h-5 w-5 flex items-center justify-center text-slate-400 hover:text-slate-900">
