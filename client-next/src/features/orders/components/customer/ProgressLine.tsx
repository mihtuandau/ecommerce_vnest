...
export function ProgressLine({ currentStatus }: ProgressLineProps) {
  ...
  const baseSteps = [
    { key: OrderStatus.PENDING, label: CUSTOMER_ORDER_STATUS_CONFIG[OrderStatus.PENDING].label },
    { key: OrderStatus.PROCESSING, label: CUSTOMER_ORDER_STATUS_CONFIG[OrderStatus.PROCESSING].label },
    { key: OrderStatus.SHIPPED, label: CUSTOMER_ORDER_STATUS_CONFIG[OrderStatus.SHIPPED].label },
    { key: OrderStatus.DELIVERED, label: CUSTOMER_ORDER_STATUS_CONFIG[OrderStatus.DELIVERED].label },
  ];
