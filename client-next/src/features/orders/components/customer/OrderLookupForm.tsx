    ...
    <div className="min-h-[80vh] bg-slate-50/30 flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-md">
        <div className="text-center mb-10 space-y-3">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Theo dõi đơn hàng</h1>
        ...
        <div className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm">
          <form onSubmit={handleLookup} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Mã đơn hàng</label>
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Số điện thoại / Email</label>
              <div className="relative group">
          ...
          <div className="mt-8 pt-8 border-t border-slate-50 text-center">
            <p className="text-[12px] text-slate-400 leading-relaxed font-medium">
              ...
              Hãy gọi <span className="text-slate-900 font-bold underline underline-offset-4 decoration-slate-200">1900 8198</span>
            </p>
          </div>
        </div>
      </div>
