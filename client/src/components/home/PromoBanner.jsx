    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col mb-14 items-center text-center">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-500 font-semibold mb-3 block">
            Ưu đãi đặc biệt
          </span>
          <h2 className="text-3xl md:text-4xl font-semibold text-black tracking-tighter uppercase mb-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="absolute inset-0 p-8 lg:p-12 flex flex-col justify-center">
              <span className="inline-block w-fit px-4 py-2 bg-white text-black text-xs uppercase tracking-wider mb-6">
                New Collection
              </span>
              ...
              <span className="w-fit px-8 py-3 bg-white text-black hover:bg-neutral-50 text-[10px] uppercase tracking-widest font-semibold transition-all border border-transparent hover:border-black">
                Khám Phá Ngay
              </span>
            ...
            <Link 
              ...
              <div className="absolute inset-0 p-6 lg:p-8 flex flex-col justify-center">
                ...
                <p className="text-white/90 mb-4 text-sm">
                  <span className="bg-white text-black px-2 py-1 text-xs uppercase tracking-wide mr-2">
                    -40%
                  </span>
                  Giảm giá lên đến 40%
                </p>
                <span className="w-fit px-6 py-2 bg-white text-black hover:bg-neutral-50 text-[10px] uppercase tracking-widest font-semibold transition-all border border-transparent hover:border-black">
                  Mua Ngay
                </span>
