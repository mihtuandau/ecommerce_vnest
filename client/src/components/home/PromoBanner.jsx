    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {/* Large Promo */}
          <div className="relative overflow-hidden h-[500px] group cursor-pointer">
            <img
            ...
            <div className="absolute inset-0 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <button className="w-fit px-8 py-3 bg-white text-gray-900 hover:opacity-80 text-xs uppercase tracking-wider transition-all">
                Khám Phá Ngay
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {/* Promo 1 */}
            <div className="relative overflow-hidden h-[238px] group cursor-pointer">
              <img
              ...
              <div className="absolute inset-0 p-6 lg:p-8 flex flex-col justify-center">
                ...
                <p className="text-white/90 mb-4 text-sm">
                  <span className="bg-white text-gray-900 px-2 py-1 text-xs uppercase tracking-wide mr-2">-40%</span>
                  Giảm giá lên đến 40%
                </p>
                <button className="w-fit px-6 py-2 bg-white text-gray-900 hover:opacity-80 text-xs uppercase tracking-wider transition-all">
                  Mua Ngay
                </button>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden h-[238px] group cursor-pointer">
              ...
              <div className="absolute inset-0 p-6 lg:p-8 flex flex-col justify-center">
                ...
                <p className="text-white/90 mb-4 text-sm">
                  <span className="bg-white text-gray-900 px-2 py-1 text-xs uppercase tracking-wide mr-2">Trend</span>
                  Xu hướng 2024
                </p>
                <button className="w-fit px-6 py-2 bg-white text-gray-900 hover:opacity-80 text-xs uppercase tracking-wider transition-all">
                  Xem Ngay
