...
const DiscountCodeSection = ({
  ...
  return (
    <div className="border-t border-gray-200 pt-5 mb-5">
      ...
      {appliedDiscount ? (
        <div className="flex items-center justify-between border border-gray-900 p-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 focus:outline-none focus:border-gray-900 text-sm transition-colors"
            onKeyPress={(e) => e.key === 'Enter' && onApplyDiscount()}
          />
          <button
            onClick={onApplyDiscount}
            disabled={checkingDiscount}
            className="px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white text-sm transition-colors disabled:opacity-50"
          >
