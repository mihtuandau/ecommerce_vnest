...
const ProductsPage = () => {
  ...
  useEffect(() => {
    const loadFilters = async () => {
      try {
        ...
        const priceRangeData = priceRangeRes || {
          minPrice: 0,
          maxPrice: 10000000,
        };
  ...
  const loadProducts = async () => {
    try {
      ...
      if (filters.categoryId)
        apiParams.categoryId = parseInt(filters.categoryId);
      ...
      if (filters.minRating)
        apiParams.minRating = parseFloat(filters.minRating);
  ...
  if (searchParams.get("sort") === "sold") {
    ...
    searchParams.get("minRating") === "4" ||
    searchParams.get("rating") === "4"
  ) {
