...
const GuestOrderDetailPage = () => {
  ...
  const loadOrder = async (contactInfo) => {
    try {
      setLoading(true);
      const response = await orderService.lookupGuestOrder(orderCode, contactInfo);
      setOrder(response);
    } catch (error) {
              ...
              <div className="bg-white border border-gray-200 overflow-hidden">
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900">{formatPrice(order.shippingFee || 0)}</span>
                  </div>
                  {order.discount > 0 && (
                ...
                <div className="p-6 space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">
                      {order.paymentMethod === 'PAYOS' ? 'PayOS - QR' : 'Tiền mặt'}
                    </span>
                  </div>
                  <div className="flex justify-between">
