        ...
        <div className="w-full max-w-lg border-2 border-gray-900 p-12">
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="px-3 py-1 bg-black text-white text-xs">
                  Đã thanh toán
                </span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-black text-white py-3 hover:bg-neutral-800 transition-colors text-sm font-normal"
