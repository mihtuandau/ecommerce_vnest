import { Controller, Get, Post, Put, Delete, Body, Param, UseGuards, Query, Req, ParseIntPipe } from '@nestjs/common';
...
export class UserController {
  ...
  @Delete(':id')
  @Roles('ADMIN')
  remove(@Param('id', ParseIntPipe) id: number, @Body() deleteUserDto: DeleteUserDto) {
