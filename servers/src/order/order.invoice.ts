...
export class OrderInvoice {
  static async generate(order: any, res: Response) {
    ...
    doc
      .fontSize(18)
      .font(bldFont)
      .text('MINH TUẤN SHOP', leftColX, 50, { width: leftColWidth });
    doc
      .fontSize(9)
      .font(regFont)
      .text(
        'Địa chỉ: 109/47 Đường số 8 Khu Phố 11, Phường Linh Xuân, Thành phố Thủ Đức, TP.HCM',
        leftColX,
        75,
        { width: leftColWidth },
      );
    doc.text('Hotline: 0984 340 962 | Website: dautuan.com', leftColX, 95, {
      width: leftColWidth,
    });

    // Right Column: Order Title & Code
    doc.fontSize(20).font(bldFont).text('HÓA ĐƠN', rightSectionX, 50, {
    ...
    doc
      .fontSize(11)
      .font(bldFont)
      .text(`Số: #${order.orderCode}`, rightSectionX, 75, {
        width: rightSectionWidth,
        align: 'right',
      });
    doc
      ...
      .text(
        ...
        rightSectionX,
        95,
        { width: rightSectionWidth, align: 'right' },
      );
    ...
    doc
      .fontSize(10)
      .font(regFont)
      .text(`Họ tên: ${customerName}`, 50, infoY + 20);
    ...
    doc
      ...
      .font(regFont)
      .text(
        `Thanh toán: ${order.paymentMethod === 'CASH' ? 'Tiền mặt' : order.paymentMethod || 'N/A'}`,
        320,
        infoY + 20,
      );
    ...
    items.forEach((item: any, i: number) => {
      ...
      doc.fontSize(10).text(`${item.quantity}`, 350, currentY, {
        width: 30,
        align: 'center',
      });
      doc.text(
    ...
    doc
      .font(bldFont)
      .fontSize(13)
      .text('TỔNG CỘNG:', labelX, totalY + 65);
    doc.text(
    ...
    doc
      .font(regFont)
      .fontSize(10)
      .text('Cảm ơn quý khách đã mua sắm tại Minh Tuấn Shop!', 50, footerY, {
        align: 'center',
        width: 500,
      });
    doc
      .fontSize(8)
      .text(
        'Hóa đơn điện tử được tạo tự động bởi hệ thống Minh Tuấn Shop.',
        50,
        footerY + 15,
