...
export class CreateDiscountDto {
  ...
  @ApiProperty({
    example: false,
    description: 'Đây có phải Flash Sale không',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    example: true,
    description: 'Mã giảm giá có đang bật hay không',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    example: [1, 2, 3],
    description: 'Danh sách ID sản phẩm gán vào Flash Sale',
    required: false,
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiProperty({
    example: 50000,
    description: 'Số tiền giảm cố định',
    required: false,
  })
  @IsOptional()
  @IsNumber()
